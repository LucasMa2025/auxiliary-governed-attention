...
│   │   └── partition.py           # ★ 网络分区处理 (v3.4.1 新增)
│   │
│   ├── monitoring/                # ★ 监控模块 (v3.4.1 新增)
│   │   └── alerts.py              # 告警规则与仪表盘
│   │
│   └── production/                # 产品化模块
│       ├── config.py              # 生产配置
...
| `aga/operator/`        | 2,400+      | 统一算子层 (+700 v3.4.1) |
| `aga/persistence/`     | 4,200+      | 多适配器持久化           |
| `aga/distributed/`     | 2,200+      | 分布式同步 (+700 v3.4.1) |
...
| `aga/monitoring/`      | 1,000+      | 监控告警 (v3.4.1 新增)   |
| `llm/`                 | 2,550       | LLM 适配器               |
